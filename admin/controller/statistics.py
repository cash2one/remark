...
class media_user(base.base):
    ...
    def statistics(self):
        data = self.importService('admin_statistics').media_statistics_by_user()
        self.out(200, '', data)


class media_platform(base.base):
    def initialize(self, config=None):
        config = {'isDataBase': True}
        base.base.initialize(self, config)
    ...
    def statistics(self):
        data = self.importService('admin_statistics').media_statistics_by_platform()
        self.out(200, '', data)
