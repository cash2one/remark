...
class base(controller.controller):
    ...
    def initialize(self, config = None):
        ...
        """
        # 加载父类初始化方法
        controller.controller.initialize(self, config)
    ...
    def page(self, intPage, intPageDataNum, intDataCount, strPageUrl):
        ...
        if intPageCount > 1:
            ...
            if intPageCount < intPageDataNum:
                ...
                ## 第几屏
                # intNum = int(math.ceil( float(intPage/10) + 1 if intPage/10 == 0 else float(intPage)/10 ))
                # print intNum
                # print '-===================='
                # if intNum == 0:
                #     intStartPageNum = 1
                ...
                intStartPageNum = intPage
                intEndPageNum = intPageCount
                if intStartPageNum + intPageDataNum < intPageCount:
                    intEndPageNum = intStartPageNum + intPageDataNum
    ...
    def get(self, **params):
        ...
        if self.isAuth and not self.auth():
            return
