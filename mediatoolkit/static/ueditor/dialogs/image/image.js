...
//                }
    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try{
                ...
                console.log("json.url = ",json['data'][0]['url'])
                Base.callback(me.editor, me.dialog, json['data'][0]['url'], json['data'][0]['state']);
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            //"<li  class=\"edui-tab-item\"><a data-context=\".edui-image-JimgSearch\" class=\"edui-tab-text\"><%=lang_tab_imgSearch%></a></li>" + // 网络图片加载
            "</ul>" +
